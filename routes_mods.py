...
def get_modrinth_info(slug):
    ...
    try:
        ...
        # 1. Získáme základní info o projektu
        ...
        # 4. Načteme typ projektu + client/server side metadata
        ...
        # 5. Detekce plugin kompatibility
        can_be_plugin = False
        all_loaders = set()
...
def get_available_mods():
    ...
    return jsonify([{
        ...
        # NOVÉ ROZŠÍŘENÍ PRO HYBRIDNÍ PROJEKTY:
